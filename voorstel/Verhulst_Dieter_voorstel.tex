...
\PaperTitle{Quantum Ledger Database tegenover traditionele oplossing bij een project met regelgevende programmanormen  }
\PaperType{Onderzoeksvoorstel Bachelorproef 2020-2021} % Type document

% TODO: vul je eigen naam in als auteur, geef ook je emailadres mee!
\Authors{Dieter Verhulst\textsuperscript{1}} % Authors
\CoPromotor{Stijn De Pestel\textsuperscript{2} (Cloudway)}
\affiliation{\textbf{Contact:}
  \textsuperscript{1} \href{mailto:dieter.verhulst@student.hogent.be}{dieter.verhulst@student.hogent.be};
  \textsuperscript{2} \href{mailto:stijn.depestel@cloudway.be}{stijn.depestel@cloudway.be};
}
...
\Keywords{Databanken en big data. Amazon QLDB --- Ledger Database} % Keywords
